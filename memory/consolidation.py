...
from CodeMate.memory.auto_memory import ENTRYPOINT_NAME, MAX_ENTRYPOINT_LINES
from CodeMate.memory.session import SessionManager
    ...
    async def _do_consolidation(
        ...
        checker = PermissionChecker(
            ...
            rule_engine=RuleEngine(
                ...
                project_rules_path=Path(self._work_dir) / ".mewcode" / "permissions.yaml",
                local_rules_path=Path(self._work_dir) / ".mewcode" / "permissions.local.yaml",
            ),
