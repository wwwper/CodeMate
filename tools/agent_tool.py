...
from CodeMate.tools.base import Tool, ToolResult
...
if TYPE_CHECKING:
    ...
    from CodeMate.client import LLMClient
...
class AgentTool(Tool):
    ...
    def _inherited_rule_engine(self) -> Any:
        ...
        父级没有权限检查器时退化为空规则集。
        """
        from CodeMate.permissions import RuleEngine
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from CodeMate.agents.fork import ForkError, build_forked_messages
        from CodeMate.agents.parser import AgentDef
        from CodeMate.agents.tool_filter import clone_registry_for_fork, resolve_agent_tools
        from CodeMate.agent import Agent as AgentClass
    ...
    async def _execute_as_teammate(self, p: AgentToolParams) -> ToolResult:
        ...
        from CodeMate.agents.fork import ForkError, build_forked_messages
        from CodeMate.agents.parser import AgentDef
        from CodeMate.agents.tool_filter import build_teammate_tools
        from CodeMate.agent import Agent as AgentClass
        from CodeMate.conversation import ConversationManager
        from CodeMate.permissions import (
            DangerousCommandDetector,
        ...
        from CodeMate.teams.models import BackendType, TeammateInfo
    ...
    def _spawn_pane_teammate(
        ...
        from CodeMate.teams.spawn import build_teammate_cli
        ...
        if mailbox is not None and p.prompt:
            from CodeMate.teams.mailbox import create_message
            from CodeMate.teams.spawn_inprocess import LEAD_NAME
            mailbox.write(
                teammate_name,
                create_message(
        ...
        try:
            if backend == BackendType.TMUX:
                from CodeMate.teams.spawn_tmux import spawn_tmux_teammate
                ...
                from CodeMate.teams.spawn_iterm2 import spawn_iterm2_teammate
    ...
    async def _execute_with_worktree(self, p: AgentToolParams) -> ToolResult:
        ...
        from CodeMate.worktree.integration import (
    ...
    def _create_client_for_model(self, model_alias: str) -> LLMClient | None:
        ...
        from CodeMate.client import create_client
        from CodeMate.config import ProviderConfig
