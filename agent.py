...
from CodeMate.conversation import ConversationManager, ToolResultBlock, ToolUseBlock
from CodeMate.conversation_pairing import REJECTED_TOOL_RESULT
from CodeMate.conversation import ThinkingBlock as ConvThinkingBlock
from CodeMate.memory.auto_memory import MemoryManager
from CodeMate.permissions import (
    Decision,
    PermissionChecker,
    PermissionMode,
)
from CodeMate.hooks import HookContext, HookEngine, ToolRejectedError
from CodeMate.hooks.engine import HookNotification
from CodeMate.prompts import build_environment_context, build_plan_mode_reminder, build_system_prompt
...
class Agent:
    def __init__(
        ...
        if memory_manager is not None:
            from CodeMate.memory.consolidation import MemoryConsolidator
    ...
    async def run(self, conversation: ConversationManager) -> AsyncIterator[AgentEvent]:
        ...
        while True:
            ...
            if self.coordinator_mode:
                from CodeMate.teams.coordinator import get_coordinator_reminder
        ...
        if self.permission_checker:
            ...
            if decision.effect == "ask":
                ...
                if response == PermissionResponse.ALLOW_ALWAYS:
                    from CodeMate.permissions.rules import Rule, extract_content
