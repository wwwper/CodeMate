...
from CodeMate.conversation import ConversationManager, Message
from CodeMate.skills.parser import SkillDef, substitute_arguments

if TYPE_CHECKING:
    from CodeMate.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from CodeMate.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
